...
3. biosample_name: text - Name of the biosample - unique values: 21
4. crm_ID: text - ID of the cis-regulatory module - unique values: 16
...
7. current_chr: categorical - Current chromosome - unique values: 2
8. disease: categorical - Disease associated - unique values: 1
9. disease_PMID: categorical - PubMed ID for disease - unique values: 1
10. disease_method: categorical - Method used for disease association - unique values: 1
11. enh2gene_PMID: categorical - PubMed ID for enhancer to gene - unique values: 2
...
16. hgnc_symbol_target_genes: text - HGNC symbol for target genes - unique values: 11
...
21. orig_chr: categorical - Original chromosome - unique values: 2
22. original_ID: categorical - Original ID - unique values: 2
23. refsnp_ID: categorical - Reference SNP ID - unique values: 3
